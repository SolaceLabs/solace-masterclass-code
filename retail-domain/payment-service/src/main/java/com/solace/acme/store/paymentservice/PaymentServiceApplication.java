package com.solace.acme.store.paymentservice;

import com.solace.acme.store.paymentservice.config.SolaceConnectionParameters;
import com.solace.acme.store.paymentservice.service.SolaceEventHandler;
...
public class PaymentServiceApplication implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        log.info("Starting the Acme Store Payment-service application");
    ...
    public void run(String... args) throws Exception {
        ...
        if (isBrokerConnected) log.info("The Acme Store Payment-service application is successfully started");
        waitForShutdown();
    }
