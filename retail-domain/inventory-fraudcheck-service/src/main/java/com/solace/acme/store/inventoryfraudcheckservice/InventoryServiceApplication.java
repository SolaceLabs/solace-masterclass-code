package com.solace.acme.store.inventoryfraudcheckservice;

import com.solace.acme.store.inventoryfraudcheckservice.config.SolaceConnectionParameters;
import com.solace.acme.store.inventoryfraudcheckservice.service.SolaceEventHandler;
...
public class InventoryServiceApplication implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        log.info("Starting the Acme Store Inventory-fraudcheck-service application");
    ...
    public void run(String... args) throws Exception {
        ...
        if (isBrokerConnected) log.info("The Acme Store Inventory-fraudcheck-service application is successfully started");
        waitForShutdown();
    }
